function drawRectangle() {
    ...
    if (canvasRectangle.getContext) {
        ctx.fillStyle = "skyblue"; // Cambiar el color del relleno
...
function drawTriangle() {
    ...
    if (canvasTriangle.getContext) {
        ctx.fillStyle = "orange"; // Cambiar el color del relleno
        ctx.beginPath();
        ctx.moveTo(25, 100);
        ctx.lineTo(125, 100);
        ctx.lineTo(75, 25);
...
function drawFeather() {
    const canvas = document.getElementById("canvasFeather");
    if (canvasFeather.getContext) {
      const ctx = canvasFeather.getContext("2d");
      ctx.strokeStyle = "limegreen"; // Cambiar el color del trazo
      ctx.beginPath();
  ...
  function drawLines() {
    ...
    if (canvas.getContext) {
      ...
      // Triángulo relleno
      ctx.fillStyle = "gold"; // Cambiar el color del relleno
      ctx.beginPath();
      ctx.moveTo(25, 25);
      ctx.lineTo(105, 25);
      ctx.lineTo(25, 105);
      ...
      ctx.strokeStyle = "brown"; // Cambiar el color del trazo
      ctx.beginPath();
      ctx.moveTo(125, 125);
      ctx.lineTo(125, 45);
      ctx.lineTo(45, 125);
  ...
  function drawCirculo() {
    const canvas = document.getElementById("canvasCirculo");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
      ctx.fillStyle = "violet"; // Cambiar el color del relleno
  ...
  function drawMente() {
    const canvas = document.getElementById("canvasMente");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
      ctx.strokeStyle = "cyan"; // Cambiar el color del trazo
  ...
  function drawNubes() {
    const canvas = document.getElementById("canvasNubes");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  
      // Ejemplo de curvas cúbicas
      ctx.fillStyle = "lightcoral"; // Cambiar el color del relleno
      ctx.beginPath();
      ctx.moveTo(75, 40);
  ...
  function drawCora() {
    const canvas = document.getElementById("canvasCora");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function drawReci() {
    const canvas = document.getElementById("canvasReci");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
      ...
      ctx.fillStyle = "salmon"; // Cambiar el color del relleno
